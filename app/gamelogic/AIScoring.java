...
//        score += getScoreForProximityToAvatar(unit, position, gameState.getHumanPlayer().getAvatar(), gameState.getAIPlayer().getAvatar());
    ...
    private static int getDistanceBetweenUnit(Unit unit, Unit target) {
        ...
        return Math.abs(unitTile.getTilex() - targetTile.getTilex()) + Math.abs(unitTile.getTiley() - targetTile.getTiley());
    }
