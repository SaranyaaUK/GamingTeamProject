...
public class CardManager {
    ...
    /**
     * Generates a deck of cards for a player. The deck is different for human and AI players.
     *
     * @param isHumanPlayer If true, generates the deck for a human player; otherwise, for an AI player.
     */
    ...
    /**
     * Draws a specified number of cards from the deck to the hand. If the deck doesn't have enough cards,
     * or the hand is at max capacity, the operation might not fully complete.
     *
     * @param CardCount The number of cards to draw.
     * @return true if the operation is successful, false if the deck is empty before drawing all cards.
     */
