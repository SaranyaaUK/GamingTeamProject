...
public class GameLogic {
    ...
    public static void notifyDeathWatchers(ActorRef out) {
        ...
        GameState gameState = GameState.getInstance();
        List<Unit> units = new CopyOnWriteArrayList<>(gameState.getHumanPlayer().getMyUnits());
    ...
    public static boolean wraithlingSummonStatus() {
        ...
        if (!(spellToCast == null)) {
            if (gameState.isSpellWraithlingSwarm()) {
                ...
                return numWraithlingSummoned < WraithlingSwarm.maximumWraithlings;
            }
        }
        return false;
    }
